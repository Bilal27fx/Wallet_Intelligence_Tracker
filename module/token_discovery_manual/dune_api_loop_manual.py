...
INPUT_JSON_PATH = Path("data/raw/json/explosive_tokens_manual.json")
EXPORT_DIR = Path("data/raw/csv/top_wallets")
CACHE_PATH = Path("data/cache/early_wallets_extracted_manual.csv")
DB_PATH = Path("data/db/wit_database.db")
