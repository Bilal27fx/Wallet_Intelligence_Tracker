...
CELERY_RESULT_EXTENDED = True  # Store task arguments and more info

# GeckoTerminal Configuration
GECKO_MIN_AGE_HOURS = 24
GECKO_MIN_PRICE_CHANGE = 20
GECKO_MIN_VOLUME = 5000
GECKO_MIN_LIQUIDITY = 3000
GECKO_MIN_FDV = 300000
GECKO_MAX_FDV = 100000000
GECKO_MIN_TXNS = 50
GECKO_MIN_BUYS_RATIO = 0.15
GECKO_MAX_POOL_AGE_DAYS = 365
GECKO_LIMIT = 30
GECKO_NETWORKS = ['base', 'bsc']
GECKO_OHLCV_AGGREGATE = 4  # 4H candles
