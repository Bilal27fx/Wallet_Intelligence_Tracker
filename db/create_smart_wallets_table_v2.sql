-- Table smart_wallets version 2 avec métriques détaillées
-- Structure identique à wallet_profiles pour cohérence
-- Contient uniquement les wallets avec score >= seuil défini
...
CREATE INDEX IF NOT EXISTS idx_smart_wallets_score ON smart_wallets(score_total DESC);
...
CREATE INDEX IF NOT EXISTS idx_smart_wallets_tranche ON smart_wallets(best_tranche_key);